...
export const PenSticker = styled(CustomImage)`
  width: 177px;
  z-index: 4;
  position: absolute;
  bottom: 1.5rem;
...
export const NotesSticker = styled(CustomImage)`
  position: absolute;
  z-index: 4;
  width: 105px;
  left: 1rem;
...
export const ToySticker = styled(CustomImage)`
  position: absolute;
  z-index: 4;
  width: 169px;
  right: 1rem;
...
export const CardsSticker = styled(CustomImage)`
  position: absolute;
  z-index: 4;
  width: 150px;
  left: 1rem;
...
export const ColorsSticker = styled(CustomImage)`
  position: absolute;
  z-index: 4;
  width: 250px;
  right: 2rem;
...
export const BulbSticker = styled(CustomImage)`
  position: absolute;
  z-index: 4;
  width: 73px;
  top: 2px;
